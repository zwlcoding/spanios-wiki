...
export const diseaseMalignantHyperthermia: DiseaseDraft = {
  ...
  quickLook: {
    whatItIs:
      'Malignant hyperthermia is included in the 2025 Chinese national rare disease guideline. Because symptoms and affected organs can vary, diagnosis and follow-up should be planned with the relevant specialist team.',
    whoToSeeFirst:
