...
export const diseasePik3caRelatedOvergrowthSyndrome: DiseaseDraft = {
  ...
  alias: 'PIK3CA相关过度生长综合征; China Second Rare Disease Catalog item 61',
  ...
  quickLook: {
    whatItIs:
      'PIK3CA-related overgrowth syndrome is included in the 2025 Chinese national rare disease guideline. Because symptoms and affected organs can vary, diagnosis and follow-up should be planned with the relevant specialist team.',
    whoToSeeFirst:
      'Start with Medical genetics or a rare disease multidisciplinary clinic when symptoms are persistent, unexplained, or involve several systems. Use emergency care for severe acute symptoms.',
    isGenetic:
