...
export const diseasePrimarySclerosingCholangitis: DiseaseDraft = {
  ...
  quickLook: {
    whatItIs:
      'Primary sclerosing cholangitis is included in the 2025 Chinese national rare disease guideline. Because symptoms and affected organs can vary, diagnosis and follow-up should be planned with the relevant specialist team.',
    whoToSeeFirst:
      'Start with Gastroenterology or a rare disease multidisciplinary clinic when symptoms are persistent, unexplained, or involve several systems. Use emergency care for severe acute symptoms.',
    isGenetic:
  ...
  patientJourney: {
    ...
    firstDepartments: [
      'Gastroenterology',
      'Hepatology or hepatobiliary surgery',
