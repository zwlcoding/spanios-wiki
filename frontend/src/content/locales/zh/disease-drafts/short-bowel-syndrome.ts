...
export const diseaseShortBowelSyndrome: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：SBS 的临床表现主要由于小肠的手术切除或功能丧失，导致肠道吸收面积显著减少。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。S BS 的诊断基于详尽的病史收集、全面的临床评估以及多种辅助检查的结合。</p><p>还需要与表现相近的疾病鉴别：以下是需要与 SBS 进行鉴别的常见疾病：炎症性肠病（IBD）包括克罗恩病和溃疡性结肠炎，二者均可能影响小肠，导致吸收不良和腹泻。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.不同疾病时期的营养策略（1）急性期治疗：SBS 的急性期通常从手术切除后开始，持续约 3～4 周。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>SBS 的临床表现主要由于小肠的手术切除或功能丧失，导致肠道吸收面积显著减少。</p>',
  diagnosis:
    '<p>S BS 的诊断基于详尽的病史收集、全面的临床评估以及多种辅助检查的结合。</p>',
  treatment:
    '<p>不同疾病时期的营养策略（1）急性期治疗：SBS 的急性期通常从手术切除后开始，持续约 3～4 周。</p>',
  prognosis:
