...
export const diseaseThalassemiaMajor: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：α地贫的临床表现变异度较大，病情的严重程度与α珠蛋白链减少的程度直接相关。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。根据重型地贫临床表现、小细胞低色素性贫血、异常血红蛋白组成及家系调查此 4 点可作出地中海贫血（重型）的临床诊断。</p><p>还需要与表现相近的疾病鉴别：常见的需要与地中海贫血（重型）鉴别诊断的疾病包括：缺铁性贫血外周血常规示小细胞低色素性贫血，但缺铁性贫血多有缺铁病因，无溶血证据，有红细胞游离原卟啉（Free erythrocyte protoporphyrin, FEP）升高、血清铁及铁蛋白降低、铁剂治疗有良好反应等特点。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前针对地中海贫血（重型）的治疗方法有以下 3 种：①规范性输血和祛铁治疗（需终生维持）；</p>',
    longTermCare:
  ...
  symptoms:
    '<p>α地贫的临床表现变异度较大，病情的严重程度与α珠蛋白链减少的程度直接相关。</p>',
  diagnosis:
    '<p>根据重型地贫临床表现、小细胞低色素性贫血、异常血红蛋白组成及家系调查此 4 点可作出地中海贫血（重型）的临床诊断。</p>',
  treatment:
    '<p>目前针对地中海贫血（重型）的治疗方法有以下 3 种：①规范性输血和祛铁治疗（需终生维持）；</p>',
  prognosis:
