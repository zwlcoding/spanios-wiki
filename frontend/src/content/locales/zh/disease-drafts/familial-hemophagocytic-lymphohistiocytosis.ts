...
export const diseaseFamilialHemophagocyticLymphohistiocytosis: DiseaseDraft = {
  ...
  plainName: '需要专科确认和长期管理的罕见病：家族性噬血细胞淋巴组织细胞增生症',
  prevalence:
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：通常表现为急性或亚急性发热性疾病，伴多器官受累。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。HLH-2004 诊断标准：目前公认的 HLH 诊断标准，由国际组织细胞协会于 2004 年修订，符合以下两条标准中任何一条时可以诊断 HLH：（1）分子诊断符合 HLH：存在目前已知的 HLH 相关致病基因，如 PRF1、 UNC13D、 S TX11、S TXBP2、Rab27a、 LYS T、S H2D1A、BIRC4、ITK、AP3β 1、MAGT1、CD27 等致病性突变。</p><p>还需要与表现相近的疾病鉴别：继发性噬血细胞综合征继发性噬血细胞综合征通常继发于感染，肿瘤，风湿等相关疾病，与 FHL的临床表现相似，但可以通过发病年龄，噬血基因筛查等鉴别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。FHL 的治疗主要分为两个阶段：首先，诱导缓解治疗主要针对过度的炎症状态，采用免疫抑制以控制 FHL 进展；</p>',
    longTermCare:
  ...
  symptoms: '<p>通常表现为急性或亚急性发热性疾病，伴多器官受累。</p>',
  diagnosis:
    '<p>HLH-2004 诊断标准：目前公认的 HLH 诊断标准，由国际组织细胞协会于 2004 年修订，符合以下两条标准中任何一条时可以诊断 HLH：（1）分子诊断符合 HLH：存在目前已知的 HLH 相关致病基因，如 PRF1、 UNC13D、 S TX11、S TXBP2、Rab27a、 LYS T、S H2D1A、BIRC4、ITK、AP3β 1、MAGT1、CD27 等致病性突变。</p>',
  treatment:
    '<p>FHL 的治疗主要分为两个阶段：首先，诱导缓解治疗主要针对过度的炎症状态，采用免疫抑制以控制 FHL 进展；</p>',
  prognosis:
