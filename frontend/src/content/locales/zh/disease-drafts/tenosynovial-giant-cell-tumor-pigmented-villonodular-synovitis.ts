...
export const diseaseTenosynovialGiantCellTumorPigmentedVillonodularSynovitis: DiseaseDraft =
  {
    ...
    medicalSections: {
      symptoms:
        '<p>主要临床表现包括：腱鞘巨细胞瘤的临床表现个体可有所不同，手足部位的局限型腱鞘巨细胞瘤早期常表现为无痛性包块，弥漫型腱鞘巨细胞瘤常见的症状有：肿胀、包块、僵硬及关节活动范围受限，以及疼痛。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
      diagnosis:
        '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。腱鞘巨细胞瘤的诊断是在临床和影像学诊断的基础上进行穿刺/切除活检病理组织学确诊。</p><p>还需要与表现相近的疾病鉴别：常见的需要与腱鞘巨细胞瘤鉴别诊断的疾病包括：痛风可以出现为关节内和关节外或关节周围的结节。</p>',
      treatment:
        '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.腱鞘巨细胞瘤的治疗决策需要在可能的治疗效果、患者个体的疾病自然病程、完全切除后局部复发的风险以及手术相关的并发症发生率之间取得平衡。</p>',
      longTermCare:
    ...
    symptoms:
      '<p>腱鞘巨细胞瘤的临床表现个体可有所不同，手足部位的局限型腱鞘巨细胞瘤早期常表现为无痛性包块，弥漫型腱鞘巨细胞瘤常见的症状有：肿胀、包块、僵硬及关节活动范围受限，以及疼痛。</p>',
    diagnosis:
      '<p>腱鞘巨细胞瘤的诊断是在临床和影像学诊断的基础上进行穿刺/切除活检病理组织学确诊。</p>',
    treatment:
      '<p>腱鞘巨细胞瘤的治疗决策需要在可能的治疗效果、患者个体的疾病自然病程、完全切除后局部复发的风险以及手术相关的并发症发生率之间取得平衡。</p>',
    prognosis:
