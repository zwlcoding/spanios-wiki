...
export const diseaseEpithelioidSarcoma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：远端型（经典型）上皮样肉瘤较为常见，通常发生在肢体远端，以下肢的足趾、前臂较为多见，尤其是手、足，病灶常位于手掌或足底。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。上皮样肉瘤的诊断需要遵循临床表现、影像学检查及病理三结合的原则，临床表现及影像学检查并无明确的特异性，因此病理为诊断的金标准。</p><p>还需要与表现相近的疾病鉴别：常见的需要与上皮样肉瘤鉴别诊断的疾病包括：肉芽肿性病变上皮样肉瘤容易与肉芽肿性病变如坏死性感染性肉芽肿、环状肉芽肿、风湿或类风湿结节等相混淆，从而延误诊断和治疗，应引起重视。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.治疗原则外科手术是上皮样肉瘤治疗的基本原则，确保足够的外科切缘，以防止肿瘤复发，在最大限度切除肿瘤的同时，尽量保留患者的功能。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>远端型（经典型）上皮样肉瘤较为常见，通常发生在肢体远端，以下肢的足趾、前臂较为多见，尤其是手、足，病灶常位于手掌或足底。</p>',
  diagnosis:
    '<p>上皮样肉瘤的诊断需要遵循临床表现、影像学检查及病理三结合的原则，临床表现及影像学检查并无明确的特异性，因此病理为诊断的金标准。</p>',
  treatment:
    '<p>治疗原则外科手术是上皮样肉瘤治疗的基本原则，确保足够的外科切缘，以防止肿瘤复发，在最大限度切除肿瘤的同时，尽量保留患者的功能。</p>',
  prognosis:
