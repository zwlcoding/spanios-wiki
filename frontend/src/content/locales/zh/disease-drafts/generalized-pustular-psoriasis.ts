...
export const diseaseGeneralizedPustularPsoriasis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：GPP 的临床表现有较强的临床异质性，根据临床表现或发病年龄，可分为 6 种亚型：急性 GPP（von Zumbusch 型）、环状脓疱型银屑病、妊娠期 GPP、婴幼儿脓疱型银屑病、GPP 的局限型及混合型脓疱型银屑病。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。GPP 的诊断主要依据临床表现及病史，必要时可借助辅助检查确诊。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 GPP 相鉴别的疾病包括：急性泛发性发疹性脓疱病起病急，临床表现与 GPP 非常相似，以水肿性红斑基础上的非毛囊性、泛发性、浅表性小脓疱为临床特征，合并高热、寒战等系统症状，实验室检查亦可见白细胞升高，部分患者会出现急性肝/肾功能损伤。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.治疗目标 GPP 的治疗需遵循规范、安全和个体化的原则，其治疗目标在于迅速控制皮肤症状及系统炎症，预防并发症出现，治疗合并症，减少疾病复发。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>GPP 的临床表现有较强的临床异质性，根据临床表现或发病年龄，可分为 6 种亚型：急性 GPP（von Zumbusch 型）、环状脓疱型银屑病、妊娠期 GPP、婴幼儿脓疱型银屑病、GPP 的局限型及混合型脓疱型银屑病。</p>',
  diagnosis:
    '<p>GPP 的诊断主要依据临床表现及病史，必要时可借助辅助检查确诊。</p>',
  treatment:
    '<p>治疗目标 GPP 的治疗需遵循规范、安全和个体化的原则，其治疗目标在于迅速控制皮肤症状及系统炎症，预防并发症出现，治疗合并症，减少疾病复发。</p>',
  prognosis:
