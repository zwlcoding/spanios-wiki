...
export const diseaseCongenitalBiliaryAtresia: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：先天性胆道闭锁婴儿往往表现为黄疸持续不退，或在生理性黄疸消退后再次出现皮肤、巩膜黄染，伴小便颜色加深，甚至呈浓茶色；</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。先天性胆道闭锁的早期筛查至关重要，比较简单易行的筛查办法是通过新生儿常规行大便比色卡筛查胆道闭锁。</p><p>还需要与表现相近的疾病鉴别：胆道闭锁需要和其他婴儿胆汁淤积性肝病相鉴别，包括胆管发育不良、进行性家族性肝内胆汁淤积症、Citrin 缺陷病、酪氨酸血症Ⅰ型、α1-抗胰蛋白酶缺乏症、先天性胆汁酸合成障碍、其他胆汁淤积性肝病。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.手术治疗胆道闭锁最重要的治疗手段是 Kasai术。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>先天性胆道闭锁婴儿往往表现为黄疸持续不退，或在生理性黄疸消退后再次出现皮肤、巩膜黄染，伴小便颜色加深，甚至呈浓茶色；</p>',
  diagnosis:
    '<p>先天性胆道闭锁的早期筛查至关重要，比较简单易行的筛查办法是通过新生儿常规行大便比色卡筛查胆道闭锁。</p>',
  treatment: '<p>手术治疗胆道闭锁最重要的治疗手段是 Kasai术。</p>',
  prognosis:
