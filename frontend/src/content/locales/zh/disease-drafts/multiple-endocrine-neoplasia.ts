...
export const diseaseMultipleEndocrineNeoplasia: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：MEN1 国外多数研究报道人群患病率约（1～3）/10 万，男女患病率大体相当，多在 30～50 岁发病。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.甲状旁腺甲状旁腺激素、血钙、血磷、游离钙（有条件时）、24h 尿钙、尿磷、骨转换指标；</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。MEN1 及 MEN4 所累及的内分泌腺体的病变为肿瘤性病变，因此多数情况下，手术治疗是首选方案，治疗的顺序取决于各种病变的严重程度；</p>',
    longTermCare:
  ...
  symptoms:
    '<p>MEN1 国外多数研究报道人群患病率约（1～3）/10 万，男女患病率大体相当，多在 30～50 岁发病。</p>',
  diagnosis:
    '<p>甲状旁腺甲状旁腺激素、血钙、血磷、游离钙（有条件时）、24h 尿钙、尿磷、骨转换指标；</p>',
  treatment:
    '<p>MEN1 及 MEN4 所累及的内分泌腺体的病变为肿瘤性病变，因此多数情况下，手术治疗是首选方案，治疗的顺序取决于各种病变的严重程度；</p>',
  prognosis:
