...
export const diseaseChronicInflammatoryDemyelinatingPolyneuropathy: DiseaseDraft =
  {
    ...
    medicalSections: {
      symptoms:
        '<p>主要临床表现包括：按照周围神经病变的分布特点和受累纤维种类，可以将 CIDP 分为两个大类，即 CIDP 经典型和 CIDP 变异型。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
      diagnosis:
        '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.周围神经病变自发生至达到高峰的时间至少 8 周，可表现为慢性进展或缓解复发。</p><p>还需要与表现相近的疾病鉴别：多种其他疾病也可以出现髓鞘病变， 如遗传压迫易感性周围神经病、Charcot-Mari-Tooth1 型、POEMS 综合征等，因此在电生理符合脱髓鞘诊断的情况时，在临床实践中，仍需结合临床进行鉴别诊断。</p>',
      treatment:
        '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。CIDP 的治疗包括免疫治疗、对症治疗、营养神经治疗和康复治疗。</p>',
      longTermCare:
    ...
    symptoms:
      '<p>按照周围神经病变的分布特点和受累纤维种类，可以将 CIDP 分为两个大类，即 CIDP 经典型和 CIDP 变异型。</p>',
    diagnosis:
      '<p>周围神经病变自发生至达到高峰的时间至少 8 周，可表现为慢性进展或缓解复发。</p>',
    treatment:
      '<p>CIDP 的治疗包括免疫治疗、对症治疗、营养神经治疗和康复治疗。</p>',
    prognosis:
