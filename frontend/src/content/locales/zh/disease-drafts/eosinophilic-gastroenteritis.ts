...
export const diseaseEosinophilicGastroenteritis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：EoGE 临床表现多样，主要取决于胃肠道受累的部位、范围和深度。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。到目前为止，EoGE 的诊断尚缺乏金标准。</p><p>还需要与表现相近的疾病鉴别：在明确胃肠道中存在嗜酸性粒细胞浸润后，应与其他引起胃肠道症状与嗜酸性粒细胞增多相关的疾病进行鉴别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。虽然已有部分治疗手段获得一定的临床证据，但 EoGE 的治疗仍缺乏统一共识指南。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>EoGE 临床表现多样，主要取决于胃肠道受累的部位、范围和深度。</p>',
  diagnosis: '<p>到目前为止，EoGE 的诊断尚缺乏金标准。</p>',
  treatment:
    '<p>虽然已有部分治疗手段获得一定的临床证据，但 EoGE 的治疗仍缺乏统一共识指南。</p>',
  prognosis:
