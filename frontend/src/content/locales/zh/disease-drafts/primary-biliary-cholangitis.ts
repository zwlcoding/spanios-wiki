...
export const diseasePrimaryBiliaryCholangitis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：在中国，越来越多的 PBC 患者是由于常规检测肝生化而在疾病早期被诊断，这些患者多无明显临床症状。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。PBC 的诊断需依据生物化学、免疫学、影像学及组织学检查进行综合评估。</p><p>还需要与表现相近的疾病鉴别：PBC 的鉴别诊断应包括其他各种病因所致的肝外或肝内胆汁淤积。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.一线治疗熊去氧胆酸（UDCA）是治疗 PBC 的一线药物。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>在中国，越来越多的 PBC 患者是由于常规检测肝生化而在疾病早期被诊断，这些患者多无明显临床症状。</p>',
  diagnosis:
    '<p>PBC 的诊断需依据生物化学、免疫学、影像学及组织学检查进行综合评估。</p>',
  treatment: '<p>一线治疗熊去氧胆酸（UDCA）是治疗 PBC 的一线药物。</p>',
  prognosis:
