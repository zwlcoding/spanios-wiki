...
export const diseaseCryopyrinAssociatedPeriodicSyndromeNlrp3AssociatedSystemicAutoinflammatoryDisease: DiseaseDraft =
  {
    ...
    medicalSections: {
      symptoms:
        '<p>主要临床表现包括：依据临床表现的轻重不同，NLRP3-AID 分为 3 种亚型，如表 19-1 所示。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
      diagnosis:
        '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。本病诊断主要依据典型临床表现，对所有出现周期性发热、荨麻疹样皮疹、关节炎、不能解释的全身炎性反应，特别是幼年起病的患者均应怀疑本病的可能。</p><p>还需要与表现相近的疾病鉴别：家族性地中海热（familial Mediterranean fever，FMF） FMF 是与 MEFV 基因突变相关的常染色体隐性遗传病，主要表现为反复发作的发热和浆膜炎导致腹痛和胸痛，发作前通常无明确诱因。</p>',
      treatment:
        '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.治疗目标由于患者终身携带突变的 NLRP3 基因，理论上无彻底治愈的可能性，国内外也未见治愈病例的报道。</p>',
      longTermCare:
    ...
    symptoms:
      '<p>依据临床表现的轻重不同，NLRP3-AID 分为 3 种亚型，如表 19-1 所示。</p>',
    diagnosis:
      '<p>本病诊断主要依据典型临床表现，对所有出现周期性发热、荨麻疹样皮疹、关节炎、不能解释的全身炎性反应，特别是幼年起病的患者均应怀疑本病的可能。</p>',
    treatment:
      '<p>治疗目标由于患者终身携带突变的 NLRP3 基因，理论上无彻底治愈的可能性，国内外也未见治愈病例的报道。</p>',
    prognosis:
