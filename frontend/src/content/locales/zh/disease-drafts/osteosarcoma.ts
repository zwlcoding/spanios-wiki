...
export const diseaseOsteosarcoma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：本病好发于股骨下端、胫骨上端与肱骨上端。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。骨肉瘤的确诊需要临床、影像、病理三结合。</p><p>还需要与表现相近的疾病鉴别：慢性骨髓炎慢性骨髓炎的临床表现可以很隐秘。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。高级别骨肉瘤确诊后，即应进行新辅助化疗（常用药物包括阿霉素、顺铂、大剂量甲氨蝶呤、异环磷酰胺）。</p>',
    longTermCare:
  ...
  symptoms: '<p>本病好发于股骨下端、胫骨上端与肱骨上端。</p>',
  diagnosis: '<p>骨肉瘤的确诊需要临床、影像、病理三结合。</p>',
  treatment:
    '<p>高级别骨肉瘤确诊后，即应进行新辅助化疗（常用药物包括阿霉素、顺铂、大剂量甲氨蝶呤、异环磷酰胺）。</p>',
  prognosis:
