...
export const diseaseMelanoma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：包括原有色素痣的增大，颜色加深，局部形成肿物，伴破溃出血。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。黑色素瘤的诊断主要依赖病理。</p><p>还需要与表现相近的疾病鉴别：常见的需要与黑色素瘤鉴别诊断的疾病包括：脂溢性角化症脂溢性角化症是常见的良性增生疾病，进展缓慢。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.手术治疗黑色素瘤手术治疗包括早中期黑色素瘤的根治性手术和晚期黑色素瘤的姑息性手术。</p>',
    longTermCare:
  ...
  symptoms: '<p>包括原有色素痣的增大，颜色加深，局部形成肿物，伴破溃出血。</p>',
  diagnosis: '<p>黑色素瘤的诊断主要依赖病理。</p>',
  treatment:
    '<p>手术治疗黑色素瘤手术治疗包括早中期黑色素瘤的根治性手术和晚期黑色素瘤的姑息性手术。</p>',
  prognosis:
