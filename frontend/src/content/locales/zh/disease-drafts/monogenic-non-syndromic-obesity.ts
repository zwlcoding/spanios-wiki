...
export const diseaseMonogenicNonSyndromicObesity: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：单基因非综合征性肥胖的临床特征因所涉及的基因不同而差异较大，但食欲过盛、严重暴食症是该病最显著的特征之一，过度进食通常导致早发性重度肥胖。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。单基因非综合征性肥胖的诊断是基于早发性严重肥胖的临床表现、家族史、辅助检查及基因检测的综合评估。</p><p>还需要与表现相近的疾病鉴别：多基因性肥胖多基因肥胖是由多个基因的协同作用共同调控，致使个体更易发展为肥胖，与遗传因素密切相关，但其发病机制比单基因肥胖更加复杂。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前，生活方式干预是治疗单基因非综合征性肥胖的基础。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>单基因非综合征性肥胖的临床特征因所涉及的基因不同而差异较大，但食欲过盛、严重暴食症是该病最显著的特征之一，过度进食通常导致早发性重度肥胖。</p>',
  diagnosis:
    '<p>单基因非综合征性肥胖的诊断是基于早发性严重肥胖的临床表现、家族史、辅助检查及基因检测的综合评估。</p>',
  treatment: '<p>目前，生活方式干预是治疗单基因非综合征性肥胖的基础。</p>',
  prognosis:
