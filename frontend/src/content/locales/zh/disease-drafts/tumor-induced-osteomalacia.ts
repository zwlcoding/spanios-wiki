...
export const diseaseTumorInducedOsteomalacia: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：骨痛以下肢痛、腰背痛或肋间痛起病，逐渐发展为全身多部位骨骼疼痛。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.临床、影像检查存在骨软化,化验检查发现存在肾磷阈下降（TmP/GFR<0.8 mmol/L）引起的低磷血症（<0.8 mmol/L），而血清钙水平正常，ALP 升高；</p><p>还需要与表现相近的疾病鉴别：TIO 疼痛症状分布广泛，定位模糊，缺乏明显特异性。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.TIO 的致病肿瘤一经定位，完整切除肿瘤是最有效的治疗方案。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>骨痛以下肢痛、腰背痛或肋间痛起病，逐渐发展为全身多部位骨骼疼痛。</p>',
  diagnosis:
    '<p>临床、影像检查存在骨软化,化验检查发现存在肾磷阈下降（TmP/GFR<0.8 mmol/L）引起的低磷血症（<0.8 mmol/L），而血清钙水平正常，ALP 升高；</p>',
  treatment: '<p>TIO 的致病肿瘤一经定位，完整切除肿瘤是最有效的治疗方案。</p>',
  prognosis:
