...
export const diseaseCystinosis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：根据患者的发病年龄、病情的严重程度及主要受累器官不同，分为三种类型：婴儿型、青少年型和成人型（眼病型）。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。对于临床表现为范科尼综合征等肾小管结构和功能异常，包括生长发育障碍、糖尿、多尿多饮、电解质失衡、脱水和/或佝偻病等症状的患儿，如果裂隙灯检测角膜有胱氨酸晶体沉着，应高度怀疑胱氨酸贮积症。</p><p>还需要与表现相近的疾病鉴别：肝豆状核变性是一种常染色体隐性遗传的铜代谢障碍遗传病，可表现为肝、肾、123神经或精神异常等;发病年龄从 3 岁到 50 岁不等。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。确诊患者，应在治疗前对患者生长发育、肾脏和肾外表现做全面评价。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>根据患者的发病年龄、病情的严重程度及主要受累器官不同，分为三种类型：婴儿型、青少年型和成人型（眼病型）。</p>',
  diagnosis:
    '<p>对于临床表现为范科尼综合征等肾小管结构和功能异常，包括生长发育障碍、糖尿、多尿多饮、电解质失衡、脱水和/或佝偻病等症状的患儿，如果裂隙灯检测角膜有胱氨酸晶体沉着，应高度怀疑胱氨酸贮积症。</p>',
  treatment:
    '<p>确诊患者，应在治疗前对患者生长发育、肾脏和肾外表现做全面评价。</p>',
  prognosis:
