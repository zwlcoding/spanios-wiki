...
export const diseaseNarcolepsy: DiseaseDraft = {
  ...
  patientJourney: {
    ...
    testsToAskAbout: [
      ...
      '是否需要影像、功能、病理或基因检测，应由专科医生结合表现决定。',
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：发作性睡病的主要临床表现包括难以抗拒的日间嗜睡、猝倒、入睡前和醒后幻觉（hypnagogic hallucinations）、睡眠瘫痪（sleep paralysis）、夜间睡眠紊乱（disturbed nocturnal sleep），其构成发作性睡病的“ 五联症”。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。发作性睡病的诊断需要收集患者的详细病史，包括睡眠习惯、日间困倦或疲劳程度以及任何可能的触发因素。</p><p>还需要与表现相近的疾病鉴别：发作性睡病的鉴别诊断主要针对出现 EDS 相关疾病的鉴别：发作性睡病最常见的症状298日间过度嗜睡应与其他疾病导致的 EDS 相鉴别：阻塞性睡眠呼吸障碍（OSA） 主要表现为上午思睡，但发作性睡病的日间思睡程度更重，在小睡后会感到一段时间的头脑清醒，而 OSA 患者在小睡后多不会感到头脑清醒。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。所有的治疗方法的目标都是优化对发作性睡病症状的控制，并让患者有一个完整的个人和职业生活。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>发作性睡病的主要临床表现包括难以抗拒的日间嗜睡、猝倒、入睡前和醒后幻觉（hypnagogic hallucinations）、睡眠瘫痪（sleep paralysis）、夜间睡眠紊乱（disturbed nocturnal sleep），其构成发作性睡病的“ 五联症”。</p>',
  diagnosis:
    '<p>发作性睡病的诊断需要收集患者的详细病史，包括睡眠习惯、日间困倦或疲劳程度以及任何可能的触发因素。</p>',
  treatment:
    '<p>所有的治疗方法的目标都是优化对发作性睡病症状的控制，并让患者有一个完整的个人和职业生活。</p>',
  prognosis:
