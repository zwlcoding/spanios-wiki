...
export const diseasePrimaryIgf1Deficiency: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：典型的患儿在出生时身高通常是正常的，但从生后第一年开始，年生长速度逐渐减慢。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。对于矮小症患者，应按照规范的流程进行全面评估。</p><p>还需要与表现相近的疾病鉴别：SPIGFD 需与生长激素缺乏症导致的矮小症相鉴别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。对于不明原因的 PIGFD 患者，在启动 IGF-1 之前应进行 GH 试验性治疗。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>典型的患儿在出生时身高通常是正常的，但从生后第一年开始，年生长速度逐渐减慢。</p>',
  diagnosis: '<p>对于矮小症患者，应按照规范的流程进行全面评估。</p>',
  treatment:
    '<p>对于不明原因的 PIGFD 患者，在启动 IGF-1 之前应进行 GH 试验性治疗。</p>',
  prognosis:
