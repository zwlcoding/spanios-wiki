...
export const diseaseNeurotrophicKeratitis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：336角膜知觉减退可触发一系列眼表及角膜的异常反应，并使角膜溃疡进展加速。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。参照《中国神经营养性角膜炎诊断及治疗专家共识(2021 年)》，神经营养性角膜炎的诊断需根据病史、角膜知觉减退和角膜损伤的体征以及相关的辅助检查结果，包括泪液、角膜知觉、神经形态等，进行综合评估。</p><p>还需要与表现相近的疾病鉴别：干眼早期存在浅层点状角膜病变的 NK 易误诊为干眼。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。NK理想的治疗方法是改善角膜三叉神经的功能，以恢复角膜神经营养供应，促进角膜上皮再生和愈合。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>角膜知觉减退可触发一系列眼表及角膜的异常反应，并使角膜溃疡进展加速。</p>',
  diagnosis:
    '<p>参照《中国神经营养性角膜炎诊断及治疗专家共识(2021 年)》，神经营养性角膜炎的诊断需根据病史、角膜知觉减退和角膜损伤的体征以及相关的辅助检查结果，包括泪液、角膜知觉、神经形态等，进行综合评估。</p>',
  treatment:
    '<p>NK理想的治疗方法是改善角膜三叉神经的功能，以恢复角膜神经营养供应，促进角膜上皮再生和愈合。</p>',
  prognosis:
