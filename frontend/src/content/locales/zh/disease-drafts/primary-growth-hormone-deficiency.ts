...
export const diseasePrimaryGrowthHormoneDeficiency: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：GHD 的临床表现取决于起病年龄、病因以及是否存在其他特殊综合征表型。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。原发性 GHD 的诊断需要结合病史、临床表现、实验室及影像学检查，同时，需排除其他病因所致身材矮小，包括家族性身材矮小、体质性生长发育延迟、甲状腺功能减退、慢性全身性疾病、特纳综合征和骨骼发育不良等。</p><p>还需要与表现相近的疾病鉴别：GHD 的临床表现并不特异，临床上需要与以下疾病鉴别，详见表 64-2。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。GHD一旦确诊需尽快接受 rhGH 治疗。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>GHD 的临床表现取决于起病年龄、病因以及是否存在其他特殊综合征表型。</p>',
  diagnosis:
    '<p>原发性 GHD 的诊断需要结合病史、临床表现、实验室及影像学检查，同时，需排除其他病因所致身材矮小，包括家族性身材矮小、体质性生长发育延迟、甲状腺功能减退、慢性全身性疾病、特纳综合征和骨骼发育不良等。</p>',
  treatment: '<p>GHD一旦确诊需尽快接受 rhGH 治疗。</p>',
  prognosis:
