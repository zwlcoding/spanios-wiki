...
export const diseaseGiantCellTumorOfBone: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：骨巨细胞瘤的主要症状是疼痛，疼痛通常呈缓慢发展并逐渐加重的特点。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。骨巨细胞瘤的诊断是在临床和影像学诊断的基础上进行穿刺活检病理组织学确诊，即使临床和影像学都显示骨巨细胞瘤的典型表现，活检仍然是必要的确诊手段。</p><p>还需要与表现相近的疾病鉴别：常见的需要与骨巨细胞瘤鉴别诊断的疾病包括：软骨母细胞瘤虽然软骨母细胞瘤也好发于骨端并可出现巨细胞，但这种肿瘤的主要特点是由均一的、密集排列的圆形/卵圆形软骨母细胞伴软骨样基质构成，软骨基质常发生钙化呈鸡笼样/格子样。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。骨巨细胞瘤最主要的治疗方法是外科手术。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>骨巨细胞瘤的主要症状是疼痛，疼痛通常呈缓慢发展并逐渐加重的特点。</p>',
  diagnosis:
    '<p>骨巨细胞瘤的诊断是在临床和影像学诊断的基础上进行穿刺活检病理组织学确诊，即使临床和影像学都显示骨巨细胞瘤的典型表现，活检仍然是必要的确诊手段。</p>',
  treatment: '<p>骨巨细胞瘤最主要的治疗方法是外科手术。</p>',
  prognosis:
