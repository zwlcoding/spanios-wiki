...
export const diseaseVonHippelLindauSyndrome: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：VHL 综合征在家系内和家系间存在明显的表型差异，不同患者各器官肿瘤发生风险不同。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。VHL 综合征的诊断主要是依据患者的发病部位和病变数目进行。</p><p>还需要与表现相近的疾病鉴别：VHL 综合征为多器官肿瘤综合征，鉴别时主要依靠基因检测及家族史信息，与散发性疾病区别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。VHL 综合征是一种遗传性疾病，目前尚无根治方法。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>VHL 综合征在家系内和家系间存在明显的表型差异，不同患者各器官肿瘤发生风险不同。</p>',
  diagnosis: '<p>VHL 综合征的诊断主要是依据患者的发病部位和病变数目进行。</p>',
  treatment: '<p>VHL 综合征是一种遗传性疾病，目前尚无根治方法。</p>',
  prognosis:
