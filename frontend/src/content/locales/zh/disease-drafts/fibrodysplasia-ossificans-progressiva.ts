...
export const diseaseFibrodysplasiaOssificansProgressiva: DiseaseDraft = {
  ...
  quickLook: {
    whatItIs:
      '进行性骨化性纤维发育不良是一种与 ACVR1/ALK2 基因变异有关的遗传性结缔组织疾病，典型表现为先天性大脚趾畸形和肌肉、筋膜等软组织逐渐发生异位骨化。',
    whoToSeeFirst:
      '如果出现骨骼发育、身高、关节、脊柱或结缔组织表现持续异常，可以先到骨科或罕见病多学科门诊评估；急性严重症状应先去急诊。',
    isGenetic:
  ...
  patientJourney: {
    whenToSuspect: [
      '出现骨骼发育、身高、关节、脊柱或结缔组织表现持续异常，且按常见病处理后仍反复或进展。',
    ...
    firstDepartments: ['骨科', '儿科骨科', '遗传咨询门诊', '康复医学科'],
    diagnosisChecklist: [
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：经典型 FOP 临床表现主要为踇外翻畸形与进行性异位骨化（HO）。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。FOP 是一种经分子遗传学证实的临床诊断。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 FOP 鉴别诊断的疾病包括：皮肌炎可能表现为肌肉疼痛、无力和肿胀。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。FOP 的管理主要为支持性，着重于预防突发事件、对患者及家庭进行教育、咨询，以及提高生活质量。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>经典型 FOP 临床表现主要为踇外翻畸形与进行性异位骨化（HO）。</p>',
  diagnosis: '<p>FOP 是一种经分子遗传学证实的临床诊断。</p>',
  treatment:
    '<p>FOP 的管理主要为支持性，着重于预防突发事件、对患者及家庭进行教育、咨询，以及提高生活质量。</p>',
  prognosis:
