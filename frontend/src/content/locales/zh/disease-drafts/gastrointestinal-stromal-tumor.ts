...
export const diseaseGastrointestinalStromalTumor: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：大多数 GIST 患者起病初期无特异性症状和体征。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.病理诊断 GIST 诊断的金标准是病理学诊断，组织病理学是 GIST 确诊和治疗的依据。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.手术治疗（1）手术适应证：局限性GIST 原则上可直接进行手术切除；</p>',
    longTermCare:
  ...
  symptoms: '<p>大多数 GIST 患者起病初期无特异性症状和体征。</p>',
  diagnosis:
    '<p>病理诊断 GIST 诊断的金标准是病理学诊断，组织病理学是 GIST 确诊和治疗的依据。</p>',
  treatment:
    '<p>手术治疗（1）手术适应证：局限性GIST 原则上可直接进行手术切除；</p>',
  prognosis:
