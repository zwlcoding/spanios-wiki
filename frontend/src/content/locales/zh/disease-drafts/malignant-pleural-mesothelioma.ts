...
export const diseaseMalignantPleuralMesothelioma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：MPM 通常起病隐匿，大多数患者在病程早期可无明显症状，确诊时的临床表现也缺乏特异性，易与其他肺部疾病相混淆。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。结合患者的症状、相关职业接触史及影像学检查，对于临床高度怀疑 MPM 的患者，应积极获取活检组织样本用于病理诊断。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 MPM 鉴别诊断的疾病包括： 其他恶性肿瘤胸膜转移因胸膜亦为其他恶性肿瘤常见转移部位，故需与其他恶性肿瘤包括肺腺癌、肺肉瘤样癌累及胸膜、肉瘤样肾细胞癌、梭形细胞肉瘤、纤维肉瘤、骨肉瘤、软骨肉瘤、脂肪肉瘤、恶性黑色素瘤等进行鉴别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1. 治疗目标当高度怀疑 MPM诊断时，应尽快由具有 MPM诊治经验的多学科团队进行评估，进行诊断、分期、风险评估和方案制订。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>MPM 通常起病隐匿，大多数患者在病程早期可无明显症状，确诊时的临床表现也缺乏特异性，易与其他肺部疾病相混淆。</p>',
  diagnosis:
    '<p>结合患者的症状、相关职业接触史及影像学检查，对于临床高度怀疑 MPM 的患者，应积极获取活检组织样本用于病理诊断。</p>',
  treatment:
    '<p> 治疗目标当高度怀疑 MPM诊断时，应尽快由具有 MPM诊治经验的多学科团队进行评估，进行诊断、分期、风险评估和方案制订。</p>',
  prognosis:
