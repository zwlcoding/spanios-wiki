...
export const diseaseNeuroblastoma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：根据原发肿瘤和转移瘤灶的部位及范围，临床表现有所不同。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.NB 诊断标准确诊 NB 需满足以下条件之一：①通过光镜对肿瘤组织进行明确的病理诊断；</p><p>还需要与表现相近的疾病鉴别：嗜铬细胞瘤嗜铬细胞瘤是起源于肾上腺髓质的肿瘤，通常分泌儿茶酚胺，患者可表现为高血压、心动过速症状，尿中儿茶酚胺及其代谢物增加，MIBG 摄取阳性，需要和NB 鉴别。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.极低危、低危 NB 治疗对于极低危、低危 NB，以手术切除为主。</p>',
    longTermCare:
  ...
  symptoms: '<p>根据原发肿瘤和转移瘤灶的部位及范围，临床表现有所不同。</p>',
  diagnosis:
    '<p>NB 诊断标准确诊 NB 需满足以下条件之一：①通过光镜对肿瘤组织进行明确的病理诊断；</p>',
  treatment: '<p>极低危、低危 NB 治疗对于极低危、低危 NB，以手术切除为主。</p>',
  prognosis:
