...
export const diseaseRettSyndrome: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：典型（经典型）Rett 综合征患者最初发育正常，但在出生后 6～18 个月开始表现出精神运动发育落后及倒退。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。当患者出现上述典型临床表现，应考虑 Rett 综合征的可能性。</p><p>还需要与表现相近的疾病鉴别：Rett 综合征临床以精神运动发育倒退、部分或完全丧失已获得的有目的的手部技能和已习得的语言、步态异常、手部刻板动作为主要表现。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前国内尚无能够有效治愈 Rett 综合征的药物和方法，因此治疗主要集中在症状管理和提高患者的生活质量。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>典型（经典型）Rett 综合征患者最初发育正常，但在出生后 6～18 个月开始表现出精神运动发育落后及倒退。</p>',
  diagnosis: '<p>当患者出现上述典型临床表现，应考虑 Rett 综合征的可能性。</p>',
  treatment:
    '<p>目前国内尚无能够有效治愈 Rett 综合征的药物和方法，因此治疗主要集中在症状管理和提高患者的生活质量。</p>',
  prognosis:
