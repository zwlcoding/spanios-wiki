...
export const diseaseVonWillebrandDiseaseType3: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：自幼发病，以皮肤、黏膜出血为主，表现为皮肤瘀点瘀斑、鼻出血和牙龈出血，严重者可伴有不同程度的缺铁性贫血；</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.有家族史者，符合常染色体隐性遗传规律。</p><p>还需要与表现相近的疾病鉴别：血友病 A 是遗传性凝血因子Ⅷ 缺乏所导致的一种 X 连锁隐性遗传病。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。3 型 VWD 患者主要治疗目的是预防和控制出血。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>自幼发病，以皮肤、黏膜出血为主，表现为皮肤瘀点瘀斑、鼻出血和牙龈出血，严重者可伴有不同程度的缺铁性贫血；</p>',
  diagnosis: '<p>有家族史者，符合常染色体隐性遗传规律。</p>',
  treatment: '<p>3 型 VWD 患者主要治疗目的是预防和控制出血。</p>',
  prognosis:
