...
export const diseaseMetachromaticLeukodystrophy: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：MLD主要按发病年龄区分为不同亚型，其中晚期婴儿型占50%～60%，青少年型占20%～30%，成人型约15%～20%。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。MLD的诊断是通过先证者的提示性临床和影像学表现(如进行性神经功能障碍、脑白质营养不良的MRI证据)和下列任何一项辅助检查结果而确定诊断，包括ARSA酶活性下降、硫脂尿液排泄量增加、周围神经或脑组织异染性脂沉积。</p><p>还需要与表现相近的疾病鉴别：在临床上需要鉴别的疾病包括各种脑病、精神疾病以及周围神经病。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。该病的治疗包括原发病治疗和症状管理，还有预防各种并发症。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>MLD主要按发病年龄区分为不同亚型，其中晚期婴儿型占50%～60%，青少年型占20%～30%，成人型约15%～20%。</p>',
  diagnosis:
    '<p>MLD的诊断是通过先证者的提示性临床和影像学表现(如进行性神经功能障碍、脑白质营养不良的MRI证据)和下列任何一项辅助检查结果而确定诊断，包括ARSA酶活性下降、硫脂尿液排泄量增加、周围神经或脑组织异染性脂沉积。</p>',
  treatment: '<p>该病的治疗包括原发病治疗和症状管理，还有预防各种并发症。</p>',
  prognosis:
