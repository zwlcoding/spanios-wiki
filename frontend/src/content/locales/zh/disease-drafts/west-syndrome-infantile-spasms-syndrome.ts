...
export const diseaseWestSyndromeInfantileSpasmsSyndrome: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：婴儿癫痫痉挛综合征通常表现为对称的、短暂的抽搐发作，涉及头、颈、手臂、腿和腹部，可能包括屈曲、伸展或屈伸结合的动作，屈曲样动作为最常见的点头抱团样发作。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。婴儿癫痫痉挛综合征的诊断通常根据癫痫发作、脑电图、起病年龄以及并发症 4 个方向进行判断（表 86-1）。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 IESS 鉴别诊断的疾病包括：反射性动作新生儿和婴儿通常有一系列的原始反射。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。主要目的是为了有效地控制婴儿的痉挛发作，促肾上腺皮质激素(ACTH)、糖皮质激素以及氨己烯酸为一线治疗药物。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>婴儿癫痫痉挛综合征通常表现为对称的、短暂的抽搐发作，涉及头、颈、手臂、腿和腹部，可能包括屈曲、伸展或屈伸结合的动作，屈曲样动作为最常见的点头抱团样发作。</p>',
  diagnosis:
    '<p>婴儿癫痫痉挛综合征的诊断通常根据癫痫发作、脑电图、起病年龄以及并发症 4 个方向进行判断（表 86-1）。</p>',
  treatment:
    '<p>主要目的是为了有效地控制婴儿的痉挛发作，促肾上腺皮质激素(ACTH)、糖皮质激素以及氨己烯酸为一线治疗药物。</p>',
  prognosis:
