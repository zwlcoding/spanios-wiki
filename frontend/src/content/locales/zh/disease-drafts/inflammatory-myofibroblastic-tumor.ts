...
export const diseaseInflammatoryMyofibroblasticTumor: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：Krzysztof Siemion 等人收集 1990 至 2021 年的相关文献，发现约 75%的 IMT 病例位于腹腔，特别是肠系膜、大网膜及腹膜后间隙，其他病例位于头颈部、肺部、膀胱、中枢神经系统、女性生殖道等区域；</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。IMT 的诊断需结合临床表现、CT 或 MRI影像学表现，病理检查及免疫组化可明确诊断，为行靶向治疗需进一步行 ALK 基因检测。</p><p>还需要与表现相近的疾病鉴别：上皮样炎性肌纤维母细胞肉瘤（Epithelioid Inflammatory Myofibroblastic Sarcoma，EIMS）是 IMT 的恶性变异型，表现为侵袭性的临床行为，预后不良。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前为止，国际上针对 IMT 没有统一的治疗方案。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>Krzysztof Siemion 等人收集 1990 至 2021 年的相关文献，发现约 75%的 IMT 病例位于腹腔，特别是肠系膜、大网膜及腹膜后间隙，其他病例位于头颈部、肺部、膀胱、中枢神经系统、女性生殖道等区域；</p>',
  diagnosis:
    '<p>IMT 的诊断需结合临床表现、CT 或 MRI影像学表现，病理检查及免疫组化可明确诊断，为行靶向治疗需进一步行 ALK 基因检测。</p>',
  treatment: '<p>目前为止，国际上针对 IMT 没有统一的治疗方案。</p>',
  prognosis:
