...
export const diseaseHutchinsonGilfordProgeriaSyndrome: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：HGPS 儿童通常在出生时表现正常，生后不久，特别是生后 1 年内逐渐开始呈现衰老征象，具体如下：皮肤和毛发皮肤和毛发异常通常是 HGPS 的初始症状，一般在 12 个月前就明显。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。2391.临床诊断如果患儿 1 岁之后出现严重生长迟缓、皮肤硬皮样改变、脱发、全身性脂肪营养不良、后颌畸形、锁骨远端吸收、指骨末端吸收、髋外翻、乳牙延迟/不完全萌出，但智力发展正常，则可以临床诊断为 HGPS。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 HGPS 鉴别诊断的疾病包括：成人早衰症（Werner syndrome，WS） WS 是一种染色体隐性方式遗传的早衰的疾病，由 WRN 基因突变引起。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。针对 HGPS 的治疗可分为对症治疗、特异性治疗和基因治疗。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>HGPS 儿童通常在出生时表现正常，生后不久，特别是生后 1 年内逐渐开始呈现衰老征象，具体如下：皮肤和毛发皮肤和毛发异常通常是 HGPS 的初始症状，一般在 12 个月前就明显。</p>',
  diagnosis:
    '<p>2391.临床诊断如果患儿 1 岁之后出现严重生长迟缓、皮肤硬皮样改变、脱发、全身性脂肪营养不良、后颌畸形、锁骨远端吸收、指骨末端吸收、髋外翻、乳牙延迟/不完全萌出，但智力发展正常，则可以临床诊断为 HGPS。</p>',
  treatment: '<p>针对 HGPS 的治疗可分为对症治疗、特异性治疗和基因治疗。</p>',
  prognosis:
