...
export const diseasePrimarySclerosingCholangitis: DiseaseDraft = {
  ...
  quickLook: {
    whatItIs:
      '原发性硬化性胆管炎（primary sclerosing cholangitis, PSC）是一类以肝内外胆管弥漫性炎症和纤维化（纤维-闭塞性胆管病）为特征的自身免疫性肝病，患者常合并炎症性肠病（以右半结肠炎最为常见）。',
    whoToSeeFirst:
      '如果出现长期腹痛腹泻、黄疸、肝功能异常、营养吸收或胆道问题，可以先到消化内科或罕见病多学科门诊评估；急性严重症状应先去急诊。',
    isGenetic:
  ...
  patientJourney: {
    whenToSuspect: [
      '出现长期腹痛腹泻、黄疸、肝功能异常、营养吸收或胆道问题，且按常见病处理后仍反复或进展。',
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：PSC 患者临床表现多样，多起病隐匿，15%～55%的患者诊断时无症状，而出现慢性胆汁淤积者大多数已有胆道狭窄或肝硬化。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。目前尚无国际上公认的 PSC 诊断标准，由于缺乏特异性的血清学及影像学诊断标志物，PSC 诊断需结合患者临床表现、生化、影像学、组织学检查等多种证据，并排除继发性的胆道损伤因素进行综合诊断。</p><p>还需要与表现相近的疾病鉴别：继发性硬化性胆管炎是指一组由明确的病因引起，临床表现与影像学表现类似硬化性胆管炎的疾病。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前为止，国际PSC诊疗指南仍未明确推荐药物治疗方案。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>PSC 患者临床表现多样，多起病隐匿，15%～55%的患者诊断时无症状，而出现慢性胆汁淤积者大多数已有胆道狭窄或肝硬化。</p>',
  diagnosis:
    '<p>目前尚无国际上公认的 PSC 诊断标准，由于缺乏特异性的血清学及影像学诊断标志物，PSC 诊断需结合患者临床表现、生化、影像学、组织学检查等多种证据，并排除继发性的胆道损伤因素进行综合诊断。</p>',
  treatment: '<p>目前为止，国际PSC诊疗指南仍未明确推荐药物治疗方案。</p>',
  prognosis:
