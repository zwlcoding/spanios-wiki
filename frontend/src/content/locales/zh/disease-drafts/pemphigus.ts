...
export const diseasePemphigus: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：寻常型天疱疮大多数寻常型天疱疮患者首先出现口腔损害，表现为水疱和糜烂，同时伴有不同程度的疼痛，严重者可因进食困难而导致体重快速下降。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。天疱疮的诊断和分型需综合临床表现、组织病理和免疫荧光等考虑。</p><p>还需要与表现相近的疾病鉴别：需要与天疱疮鉴别诊断的疾病包括：大疱性类天疱疮临床表现为皮肤水疱，疱壁较厚，不易破溃，尼氏征阴性。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.治疗目标天疱疮的治疗可分为初始阶段和巩固维持阶段。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>寻常型天疱疮大多数寻常型天疱疮患者首先出现口腔损害，表现为水疱和糜烂，同时伴有不同程度的疼痛，严重者可因进食困难而导致体重快速下降。</p>',
  diagnosis:
    '<p>天疱疮的诊断和分型需综合临床表现、组织病理和免疫荧光等考虑。</p>',
  treatment: '<p>治疗目标天疱疮的治疗可分为初始阶段和巩固维持阶段。</p>',
  prognosis:
