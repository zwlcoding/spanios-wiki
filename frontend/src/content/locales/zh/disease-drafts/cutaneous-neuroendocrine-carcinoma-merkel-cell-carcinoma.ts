...
export const diseaseCutaneousNeuroendocrineCarcinomaMerkelCellCarcinoma: DiseaseDraft =
  {
    ...
    medicalSections: {
      symptoms:
        '<p>主要临床表现包括：MCC 典型临床表现为坚硬、无症状、无压痛的肉色或红色结节或斑块，通常在几周或几个月内迅速增大。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
      diagnosis:
        '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。1.皮肤镜 MCC 的皮肤镜检查显示主要为乳红色或粉红色无结构区，可有多形性血管存在，包括点状、肾小球状、树突状和线状不规则血管。</p>',
      treatment:
        '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.治疗原则尽可能切除肿瘤或降低肿瘤负荷，延长生存期，降低复发率。</p>',
      longTermCare:
    ...
    symptoms:
      '<p>MCC 典型临床表现为坚硬、无症状、无压痛的肉色或红色结节或斑块，通常在几周或几个月内迅速增大。</p>',
    diagnosis:
      '<p>皮肤镜 MCC 的皮肤镜检查显示主要为乳红色或粉红色无结构区，可有多形性血管存在，包括点状、肾小球状、树突状和线状不规则血管。</p>',
    treatment:
      '<p>治疗原则尽可能切除肿瘤或降低肿瘤负荷，延长生存期，降低复发率。</p>',
    prognosis:
