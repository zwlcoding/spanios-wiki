...
export const diseaseSystemicJuvenileIdiopathicArthritis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：发热高热是该病的突出特点，体温每日波动于 36～41℃之间，骤升骤降，一日内可出现 1～2 次高峰，高热时可伴寒战和全身中毒症状，如乏力、食欲减退、肌肉和关节疼痛等，热退后患儿精神反应如常，无明显痛苦。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。目前临床广泛应用的诊断标准是 2001 年国际风湿病联盟（ILAR）提出并修订的 JIA分类标准。</p><p>还需要与表现相近的疾病鉴别：sJIA 缺乏特异性诊断指标，因此鉴别诊断非常重要。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。sJIA 的总体治疗目标是在 6～12 个月内达到疾病临床缓解。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>发热高热是该病的突出特点，体温每日波动于 36～41℃之间，骤升骤降，一日内可出现 1～2 次高峰，高热时可伴寒战和全身中毒症状，如乏力、食欲减退、肌肉和关节疼痛等，热退后患儿精神反应如常，无明显痛苦。</p>',
  diagnosis:
    '<p>目前临床广泛应用的诊断标准是 2001 年国际风湿病联盟（ILAR）提出并修订的 JIA分类标准。</p>',
  treatment: '<p>sJIA 的总体治疗目标是在 6～12 个月内达到疾病临床缓解。</p>',
  prognosis:
