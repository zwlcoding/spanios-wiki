...
export const diseaseFacioscapulohumeralMuscularDystrophy: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：FSHD 的发病年龄、进展和严重程度存在家系间/家系内个体差异。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。FSHD 的临床辨识度较高，诊断需要结合特征性核心表型与家族史、实验室检查以及基因检测。</p><p>还需要与表现相近的疾病鉴别：肢带型肌营养不良多于 10～20 岁起病，主要表现为对称性肩胛带和骨盆带肌无力和萎缩，可伴假性肌肥大，较少累及面肌，病程缓慢进展，常染色体显性或隐性遗传，肌电图提示肌源性损害，缺陷蛋白的肌肉免疫病理检测可辅助诊断，肌肉 MRI 及基因检测有助于鉴别及分类。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。目前尚无特效药物，治疗策略分为两类：增加肌肉体积或力量适量有氧运动有益，不仅改善心血管健康，还可以增加力量。</p>',
    longTermCare:
  ...
  symptoms: '<p>FSHD 的发病年龄、进展和严重程度存在家系间/家系内个体差异。</p>',
  diagnosis:
    '<p>FSHD 的临床辨识度较高，诊断需要结合特征性核心表型与家族史、实验室检查以及基因检测。</p>',
  treatment:
    '<p>目前尚无特效药物，治疗策略分为两类：增加肌肉体积或力量适量有氧运动有益，不仅改善心血管健康，还可以增加力量。</p>',
  prognosis:
