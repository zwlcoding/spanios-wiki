...
export const diseasePrimaryImmunodeficiency: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：由于病因不同，PID 的临床表现极为复杂，但也有共性。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。目前，PID 诊断尚无统一标准，仅部分病种如重症联合免疫缺陷有诊断及管理指南。</p><p>还需要与表现相近的疾病鉴别：营养不良时的免疫缺陷、蛋白质营养不良和微营养素缺乏对免疫系统产生不良影响，包括细胞免疫、吞噬功能、补体等多方面受损。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。1.一般处理加强家庭宣教，早期诊断、早期识别、早期治疗，增强父母和患儿对抗疾病的信心等是提高 PID 患者生活质量及生存率最重要的因素之一。</p>',
    longTermCare:
  ...
  symptoms: '<p>由于病因不同，PID 的临床表现极为复杂，但也有共性。</p>',
  diagnosis:
    '<p>目前，PID 诊断尚无统一标准，仅部分病种如重症联合免疫缺陷有诊断及管理指南。</p>',
  treatment:
    '<p>一般处理加强家庭宣教，早期诊断、早期识别、早期治疗，增强父母和患儿对抗疾病的信心等是提高 PID 患者生活质量及生存率最重要的因素之一。</p>',
  prognosis:
