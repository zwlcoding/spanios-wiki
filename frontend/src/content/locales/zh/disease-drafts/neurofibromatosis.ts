...
export const diseaseNeurofibromatosis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：NF1 最常见的临床表现为 CALMs 和神经纤维瘤。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。既往 NF1 的诊断主要依据 1987 年美国国立卫生研究院（National Institutes of Health,NIH）提出的诊断标准。</p><p>还需要与表现相近的疾病鉴别：多发 CALMs 也可见于 Legius 综合征、McCune-Albright 综合征、Noonan 综合征、结构性错配修复缺陷综合征等疾病。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。NF1 的治疗需要多学科联合治疗，涉及皮肤科、整形外科、肿瘤科、神经外科、放射科、眼科、骨科、神经内科、心内科、儿科、内分泌科、遗传学等。</p>',
    longTermCare:
  ...
  symptoms: '<p>NF1 最常见的临床表现为 CALMs 和神经纤维瘤。</p>',
  diagnosis:
    '<p>既往 NF1 的诊断主要依据 1987 年美国国立卫生研究院（National Institutes of Health,NIH）提出的诊断标准。</p>',
  treatment:
    '<p>NF1 的治疗需要多学科联合治疗，涉及皮肤科、整形外科、肿瘤科、神经外科、放射科、眼科、骨科、神经内科、心内科、儿科、内分泌科、遗传学等。</p>',
  prognosis:
