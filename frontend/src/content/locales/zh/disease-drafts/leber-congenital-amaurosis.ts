...
export const diseaseLeberCongenitalAmaurosis: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：LCA 由德国眼科医生 Theodor Leber 在 1869 年命名，可分为仅表现为遗传性视网膜变性（孤立型）及合并眼部其他疾病或全身其他系统异常的综合征型。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。LCA 诊断标准：① 6 个月龄前出现严重视力低下或盲，可伴有眼球震颤、指眼征、瞳孔对光反射迟钝等；</p><p>还需要与表现相近的疾病鉴别：LCA 临床上容易被误诊的疾病包括全色盲、先天性静止性夜盲、眼型白化病和视神经发育不良等。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。LCA 的患者在有效治疗广泛开展之前，绝大多数预后较差，在孩童时期即成为法定盲人。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>LCA 由德国眼科医生 Theodor Leber 在 1869 年命名，可分为仅表现为遗传性视网膜变性（孤立型）及合并眼部其他疾病或全身其他系统异常的综合征型。</p>',
  diagnosis:
    '<p>LCA 诊断标准：① 6 个月龄前出现严重视力低下或盲，可伴有眼球震颤、指眼征、瞳孔对光反射迟钝等；</p>',
  treatment:
    '<p>LCA 的患者在有效治疗广泛开展之前，绝大多数预后较差，在孩童时期即成为法定盲人。</p>',
  prognosis:
