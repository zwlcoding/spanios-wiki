...
export const diseaseGlioblastoma: DiseaseDraft = {
  ...
  medicalSections: {
    symptoms:
      '<p>主要临床表现包括：GBM 生长迅速，通常临床症状进展也较快，表现出数日至数周内进展的亚急性神经系统症状和体征。</p><p>不同患者不一定会出现所有表现，症状轻重也可能随年龄、病程和合并问题而变化。</p>',
    diagnosis:
      '<p>诊断通常需要把病史、体格检查、专科检查和必要的实验室/影像/病理或遗传检测放在一起判断。除了症状、体征及影像学支持，GBM 的确诊有赖于组织及分子病理学结果。</p><p>还需要与表现相近的疾病鉴别：常见的需要与 GBM 鉴别诊断的疾病包括：低级别胶质瘤低级别胶质瘤生长较慢，症状进展缓慢，MRI 信号相对均匀，长 T1、长 T2 和液体衰减反转恢复序列（fluid- attenuated inversion recovery, FLAIR）高信号，多无强化，与 GBM 具有不同的组织病理及分子病理特征。</p>',
    treatment:
      '<p>治疗应由相关专科根据疾病阶段、严重程度、受累器官和药物可及性制定。脑胶质瘤治疗需要神经外科、神经影像科、放射治疗科、神经肿瘤科、病理科和神经康复科等多学科合作（multi- disciplinary team，MDT）。</p>',
    longTermCare:
  ...
  symptoms:
    '<p>GBM 生长迅速，通常临床症状进展也较快，表现出数日至数周内进展的亚急性神经系统症状和体征。</p>',
  diagnosis:
    '<p>除了症状、体征及影像学支持，GBM 的确诊有赖于组织及分子病理学结果。</p>',
  treatment:
    '<p>脑胶质瘤治疗需要神经外科、神经影像科、放射治疗科、神经肿瘤科、病理科和神经康复科等多学科合作（multi- disciplinary team，MDT）。</p>',
  prognosis:
