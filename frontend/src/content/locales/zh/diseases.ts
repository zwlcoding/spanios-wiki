...
export const zhDiseaseDrafts: DiseaseDraft[] = [
  ...
  },
  {
    ...
    slug: 'hemophilia-a',
    oneSentence:
      '血友病 A 是 F8/凝血因子 VIII 相关的遗传性出血性疾病，核心风险是关节、肌肉、手术或外伤后出血时间延长，重型患者需要长期预防和急救计划。',
    plainName: '凝血因子 VIII 不足导致血液不容易止住的遗传病',
    prevalence: '男性新生儿约 1/5,000，重型病例需要长期规范管理。',
    quickLook: {
      whatItIs:
        '凝血因子 VIII 活性不足时，身体形成稳定血凝块的能力下降。轻型患者可能只在拔牙、手术或较大外伤后出血异常；重型患者可反复发生关节和肌肉出血。',
      whoToSeeFirst:
        '反复关节肿痛、肌肉血肿、拔牙或手术后止血困难、婴幼儿不明原因大块瘀斑时，优先看血液科/儿科血液科或凝血专病门诊；头部外伤、颈咽部出血、深部出血应急诊。',
      isGenetic:
        '通常为 X 连锁遗传，与 F8 基因有关。男性更常受累，女性携带者也可能因凝血因子水平偏低而有出血风险。',
      hasTreatment:
        '有急性止血、预防治疗、非因子治疗、围手术期管理和康复关节保护方案。具体方案取决于严重程度、出血频率、是否有抑制物和药物可及性。',
      commonDelayReason:
        '轻型血友病 A 可能到拔牙、手术或外伤后才发现；女性携带者的月经过多、产后或术后出血也容易被低估。',
    },
    patientJourney: {
      whenToSuspect: [
        '儿童反复出现大块瘀斑、关节肿痛、肌肉血肿，或小外伤后出血时间明显延长。',
        '拔牙、包皮环切、手术、分娩或创伤后出血延迟、反复或难以止住。',
        '婴幼儿头部外伤后肿胀异常，或出现不明原因颅内出血。',
        '家族中有血友病 A、男性亲属出血病史，女性成员有月经过多、术后或产后出血。',
        '化验提示 aPTT 延长，而血小板计数和 PT 相对正常。',
      ],
      commonWrongTurns: [
        '把儿童瘀斑都归因于磕碰或活动量大，没有追问家族史和做凝血检查。',
        '关节出血被当作扭伤、关节炎或感染处理，延误止血和关节保护。',
        '轻型患者术前没有说明既往出血史，直到术后出血才被发现。',
        '认为女性携带者一定没有症状，没有检测凝血因子水平。',
        '自行使用可能增加出血风险的药物，或没有专科方案就做侵入性操作。',
      ],
      firstDepartments: [
        '血液科/儿科血液科',
        '凝血专病门诊或血友病诊疗中心',
      ...
      diagnosisChecklist: [
        '记录出血部位、持续时间、诱因、止血处理、既往手术/拔牙出血史和家族史。',
        '带上 aPTT、PT、血小板、纤维蛋白原、凝血因子 VIII 活性和 von Willebrand 因子相关结果。',
        '向医生确认是否需要 F8 基因检测、家系验证和女性亲属携带者评估。',
        '确诊后询问是否需要抑制物检测、关节评估、疫苗/感染筛查和家庭急救卡。',
      ],
      testsToAskAbout: [
        '凝血因子 VIII 活性测定和必要时重复检测。',
        'aPTT、PT、血小板计数、纤维蛋白原和 von Willebrand 因子相关检查。',
        'F8 基因检测及家系验证。',
        '抑制物检测。',
        '关节超声或 MRI、感染筛查和治疗安全性监测。',
      ],
      questionsForDoctor: [
        '我是轻型、中型还是重型血友病 A？依据是什么？',
        '我适合按需治疗还是预防治疗？在家怎样识别关节或肌肉出血？',
        '是否存在抑制物？这会怎样影响治疗选择？',
        '拔牙、手术、运动、旅行和急诊时需要怎样的书面计划？',
        '女性亲属和未来生育计划需要做哪些检测和遗传咨询？',
      ],
    },
    searchIntents: [
      '血友病 A 看什么科',
    ...
    medicalSections: {
      symptoms:
        '<p>血友病 A 可表现为外伤、拔牙或手术后出血时间延长，反复鼻出血、口腔出血、大块瘀斑、肌肉血肿、关节出血、尿血或消化道出血。重型患者可出现自发性关节或肌肉出血，反复关节出血会导致疼痛、活动受限和血友病性关节病。轻型患者可能到成年后因手术或拔牙才被发现。</p>',
      diagnosis:
        '<p>诊断依靠凝血因子 VIII 活性检测，并结合 aPTT、PT、血小板、von Willebrand 因子相关检查和家族史。F8 基因检测可帮助确认类型、进行家系筛查和生育咨询。确诊后还需要评估抑制物，因为抑制物会明显影响止血治疗方案。</p>',
      treatment:
        '<p>管理包括急性出血处理、预防治疗、非因子治疗、围手术期计划、康复训练和关节保护。部分成人可评估基因治疗等选择，但并非所有人都适合。具体治疗应由血液科根据因子水平、出血频率、抑制物、年龄和当地药物可及性制定。</p>',
      longTermCare:
        '<p>长期照护重点是减少关节和肌肉出血、保护关节功能、管理疼痛和运动、监测抑制物、评估治疗安全性，并随身携带急诊信息卡。手术、拔牙、侵入性检查或开始新药前，应提前联系血液科制定止血方案。</p>',
      fertilityOrFamily:
        '<p>血友病 A 通常为 X 连锁遗传。女性携带者可能因凝血因子水平偏低而有出血风险。明确家族 F8 变异后，亲属可通过遗传咨询了解携带者检测、产前诊断、胚胎植入前遗传学检测和分娩出血管理。</p>',
      emergencySigns:
        '<p>头部外伤、头痛伴呕吐或意识改变，颈部/咽喉出血伴呼吸困难，腹痛或背痛提示内出血，关节或肌肉肿痛快速加重，或外伤/手术后出血不能控制时，应立即急诊，并主动说明血友病 A 类型和既往治疗方案。</p>',
    },
    sources: [
      {
      ...
      {
        name: 'World Federation of Hemophilia Guidelines for the Management of Hemophilia',
        type: 'clinical-guideline',
  ...
  },
  {
    ...
    prevalence:
      'IHH总体发病率约1~10/100,000。卡尔曼综合征（KS）约占全部IHH患者的40%~60%，在芬兰患病率约1/48,000，男性多于女性。部分KS患者可出现自发缓解（约10%~20%）。',
    quickLook: {
      whatItIs:
    ...
    medicalSections: {
      ...
      longTermCare:
        'IHH患者需要长期随访管理。治疗期间需定期监测激素水平、第二性征发育情况、生化指标和骨密度。促生育治疗患者需在生殖医学中心规律就诊，监测卵泡发育和精子生成。停止治疗后需每年监测性激素水平和睾丸/卵巢功能，警惕自发性逆转。长期性激素缺乏可导致骨质疏松，需补充钙剂和维生素D，适度负重运动。关注患者心理健康，部分患者因性发育问题和生育困难产生焦虑或抑郁。遗传咨询对计划生育有重要价值。',
      fertilityOrFamily:
        '大多数IHH患者经治疗后可以生育亲生子女。男性患者接受hCG+/-FSH治疗后，约70%~90%可出现精子生成，其中部分可自然受孕，其余可借助辅助生殖技术。约10%~20%的患者在停止治疗后出现自发性逆转（恢复内源性GnRH分泌），可能与基因突变类型和既往治疗有关。遗传咨询建议已知基因突变携带者在计划妊娠前进行遗传咨询，了解遗传风险和产前诊断选项。',
      emergencySigns:
